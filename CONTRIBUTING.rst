...
Report bugs at https://github.com/romnn/datemore/issues.
...
The best way to send feedback is to `file an issue <https://github.com/romnn/datemore/issues>`_ on GitHub.
...
1. Fork the `datemore repo <https://github.com/romnn/datemore>`_ on GitHub.
...
3. The pull request should work for python 3.5+. Check the
   `build status of your pull request <https://travis-ci.com/romnn/datemore/pull_requests>`_
...
.. _GitHub issues: https://github.com/romnn/datemore/issues
